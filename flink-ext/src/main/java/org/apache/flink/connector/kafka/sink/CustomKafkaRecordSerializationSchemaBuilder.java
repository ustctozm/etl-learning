...
/**
 * Builder to construct {@link CustomKafkaRecordSerializationSchemaBuilder}.
 *
 ...
 */
@PublicEvolving
public class CustomKafkaRecordSerializationSchemaBuilder<IN> {
     ...
     * @return {@code this}
     */
    public <T extends IN> CustomKafkaRecordSerializationSchemaBuilder<T> setPartitioner(
            FlinkKafkaPartitioner<? super T> partitioner) {
        CustomKafkaRecordSerializationSchemaBuilder<T> self = self();
     ...
     * @return {@code this}
     */
    public CustomKafkaRecordSerializationSchemaBuilder<IN> setTopic(String topic) {
     ...
     * @return {@code this}
     */
    public <T extends IN> CustomKafkaRecordSerializationSchemaBuilder<T> setTopicSelector(
     ...
     * @return {@code this}
     */
    public <T extends IN> CustomKafkaRecordSerializationSchemaBuilder<T> setKeySerializationSchema(
     ...
     * @return {@code this}
     */
    public <T extends IN> CustomKafkaRecordSerializationSchemaBuilder<T> setKafkaKeySerializer(
    ...
    CustomKafkaRecordSerializationSchemaBuilder<T> setKafkaKeySerializer(
     ...
     * @return {@code this}
     */
    public <T extends IN> CustomKafkaRecordSerializationSchemaBuilder<T> setValueSerializationSchema(
     ...
     * @return {@code this}
     */
    public <T extends IN> CustomKafkaRecordSerializationSchemaBuilder<T> setHeaderProvider(
    ...
    private <T extends IN> CustomKafkaRecordSerializationSchemaBuilder<T> self() {
        return (CustomKafkaRecordSerializationSchemaBuilder<T>) this;
    }
     ...
     * @return {@code this}
     */
    public <T extends IN> CustomKafkaRecordSerializationSchemaBuilder<T> setKafkaValueSerializer(
     ...
     */
    public <T extends IN, S extends Serializer<? super T>>
    CustomKafkaRecordSerializationSchemaBuilder<T> setKafkaValueSerializer(
    ...
    /**
     * Constructs the {@link CustomKafkaRecordSerializationSchemaWrapper} with the configured properties.
     *
     * @return {@link CustomKafkaRecordSerializationSchema}
     */
    public CustomKafkaRecordSerializationSchema<IN> build() {
        ...
        return new CustomKafkaRecordSerializationSchemaWrapper<>(
                topicSelector,
    ...
    public static class CustomKafkaRecordSerializationSchemaWrapper<IN>
            implements CustomKafkaRecordSerializationSchema<IN> {
        ...
        private TopicPartitions topicPartitions;

        public FlinkKafkaPartitioner<? super IN> getPartitioner() {
            return partitioner;
        }

        public TopicPartitions getTopicPartitions() {
            return topicPartitions;
        }

        public CustomKafkaRecordSerializationSchemaWrapper<IN> setTopicPartitions(TopicPartitions topicPartitions) {
            this.topicPartitions = topicPartitions;
            return this;
        }

        CustomKafkaRecordSerializationSchemaWrapper(
            ...
            this.partitioner = partitioner != null ? partitioner : new FlinkFixedPartitioner<>();
        ...
        public void open(
            ...
            topicPartitions = new TopicPartitions(3);
        }
        ...
        public ProducerRecord<byte[], byte[]> serialize(
            ...
            if (null == partitions) {
                partitions = context.getPartitionsForTopic(targetTopic);
            ...
            final OptionalInt partition =
                    partitioner != null
                            ...
                            partitioner.partition(
                                    ...
                                    value,
                                    targetTopic,
                                    topicPartitions.getAvailablePartitions(targetTopic)))
                            : OptionalInt.empty();
