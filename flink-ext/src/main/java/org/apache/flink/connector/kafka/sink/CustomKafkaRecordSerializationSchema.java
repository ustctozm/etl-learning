 ...
 */
@PublicEvolving
public interface CustomKafkaRecordSerializationSchema<T> extends Serializable {
     ...
     */
    static <T> CustomKafkaRecordSerializationSchemaBuilder<T> builder() {
        return new CustomKafkaRecordSerializationSchemaBuilder<>();
    }
}
