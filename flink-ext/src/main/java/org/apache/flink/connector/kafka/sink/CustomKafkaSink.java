 ...
 */
@PublicEvolving
public class CustomKafkaSink<IN>
    ...
    @Internal
    @Override
    public CustomKafkaWriter<IN> createWriter(InitContext context) throws IOException {
        return new CustomKafkaWriter<IN>(
                deliveryGuarantee,
                kafkaProducerConfig,
    ...
    @Internal
    @Override
    public CustomKafkaWriter<IN> restoreWriter(
